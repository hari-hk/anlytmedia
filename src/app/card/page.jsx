...
export default function Card() {
  ...
  return (
    <div className='min-h-screen  flex flex-col items-center justify-center p-4 linear-gradient bg-gradient-to-b from-teal-600 to-teal-800'>
      <div className='w-[350px] shadow-xl border border-gray-200 bg-white rounded-lg'>
        <div className='p-6'>
          <div className='flex flex-col items-center text-center relative'>
            <div className='absolute w-24 shadow-xl h-24 bg-teal-700 rounded-full mb-4 -top-16'>
              <Image
            ...
            <ul className='space-y-3 text-sm text-gray-600'>
              ...
              <li className='flex items-start justify-start gap-2 text-left'>
                ...
                18/16/3, Elavuvilai Jn, Marthandam, TN 629191, India
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className='w-[350px] shadow-xl border border-gray-200 bg-white rounded-lg'>
        <div className='p-6'>
          <div className='flex flex-row items-center gap-2 wrap text-center justify-around '>
            ...
            <div className='size-10 border drop-shadow-md shadow-teal-100  rounded-full flex items-center justify-center '>
            ...
            <div className='size-10 border drop-shadow-md shadow-teal-100  rounded-full flex items-center justify-center '>
              <Link href='https://www.twitter.com/anlytmedia'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
                  height='16'
