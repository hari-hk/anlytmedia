...
FN:Ananda Sayanan
ORG:Anlyt Media
TEL;TYPE=CELL:+917092828370
TEL;TYPE=WORK:+918428524861
ADR;TYPE=WORK:;;18/16/3, Elavuvilai Jn;Marthandam;TN;629191;India
          ...
          <div className='flex flex-col items-center text-center relative'>
            ...
            <ul className='space-y-3 text-sm text-white'>
              ...
              <li className='flex items-start justify-start gap-2 text-left'>
                ...
                18/16/3, Elavuvilai Jn, Marthandam, TN 629171, India
              </li>
            </ul>
          </div>
        </div>
